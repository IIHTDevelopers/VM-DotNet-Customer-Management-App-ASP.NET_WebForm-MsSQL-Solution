...
namespace CustomerManagementApp.Tests.TestCases
{
    public class BoundaryTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Add_Customer_NotNull()
        {
            //Arrange
            var res = false;
            ...
            try
            {
                customerservice.Setup(repos => repos.Add()).Returns("");
        ...
        [Fact]
        public async Task<bool> Testfor_Delete_Customer_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
            ...
            try
            {
                customerservice.Setup(repos => repos.Delete()).Returns("");
        ...
        [Fact]
        public async Task<bool> Testfor_UpdateCustomer_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_GetByIdCustomer_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_GetByAll_NotNull()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_AddCustomer_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        [Fact]
        public async Task<bool> Testfor_DeleteCustomer_ReturnsString()
        {
            //Arrange
            var res = false;
            string testName; string status;
